...
//Should include 2 options .. seat reservation , seat cancellation
//Only available seats should be displayed if selected seat reservation .
// And a record must be maintained of allotted seats in a file system .
//And for cancellation .
//It also should be deleted from the record in the file system and seat should be made available after that .
//And at the end a boarding pass must be printed for the seat booked
